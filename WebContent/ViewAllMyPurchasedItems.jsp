<%-- 
    Document   : ViewAllMyPurchasedItems
    Created on : Feb 6, 2018, 10:09:38 PM
    Author     : kishan
--%>
...
<center><div id="main">
        ...
        <div id="login">
                ...
                <table border="1">
                    <font color="orange"><h2>All Purchased Items</h2></font>
                    <%@page import="java.sql.*" %>
                    <%@page import="com.java.ConnectionProvider" %>
                    ...
                    <tr><th>UserName</th><th>Product Name</th><th>Date</th><th>Cost</th></tr>
                    <%while(rs.next()){
...
<tr><td><%=username1%></td><td><%=productname%></td><td><%=date %></td><td><%=cost%></td></tr>
